...
ALL_MEANS = {
    ...
    'fr_facenet': [127.5, 127.5, 127.5],
    'fr_irse50': [127.5, 127.5, 127.5],
    'fr_ir152': [127.5, 127.5, 127.5],
    'fr_mobile_face': [127.5, 127.5, 127.5],
}
ALL_STDS = {
    'vgg16': [1., 1., 1.],
    'vgg16_5class': [1., 1., 1.],
    ...
    'fr_facenet': [128.0, 128.0, 128.0],
    'fr_irse50': [128.0, 128.0, 128.0],
    'fr_ir152': [128.0, 128.0, 128.0],
    'fr_mobile_face': [128.0, 128.0, 128.0],
}
...
def add_conf_to_tensor_(tensor, conf, color, highlight):
    ...
    if CONF_MASKS is None:
        CONF_MASKS = torch.load('./CACHE/conf_mask.pt')
